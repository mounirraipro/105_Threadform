...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Thread Form. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Thread Form sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Thread Form' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Thread Form?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Thread Form.</p>
                </div>
            </div>
