...
export const metadata: Metadata = {
    ...
    description: 'Thread Form is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Thread Form accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Thread Form accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Thread Form is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Thread Form presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Thread Form. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@threadform.org</strong></li>
                </ul>
                <p>
