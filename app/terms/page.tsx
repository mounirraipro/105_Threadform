...
export const metadata: Metadata = {
    ...
    description: 'Read the Thread Form Terms of Service. Understand the rules and guidelines for using our free online game.',
    keywords: ['Thread Form terms of service', 'terms and conditions', 'usage agreement'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    Welcome to Thread Form. By accessing or using our website and game, you agree to be
                    bound by these Terms of Service. Please read them carefully before using our services.
                </p>

                <h2>1. Acceptance of Terms</h2>
                <p>
                    By accessing Thread Form at threadform.org, you acknowledge that you have read,
                ...
                <p>
                    Thread Form provides a free, browser-based game. Thread Form is a free, browser-based game experience.
                    The service includes the game itself, educational content, blog articles, and related resources.
                </p>

                <h2>3. User Eligibility</h2>
                <p>
                    Thread Form is available to users of all ages. However, users under 13 years of age
                ...
                <p>
                    All content on Thread Form — including but not limited to the game design, code, images,
                    text, graphics, logos, and audio — is the intellectual property of Thread Form or its
                ...
                <p>
                    ...
                    Thread Form for personal, non-commercial purposes only.
                </p>

                <h2>5. Acceptable Use</h2>
                <p>When using Thread Form, you agree NOT to:</p>
                <ul>
                ...
                <p>
                    ...
                    grant Thread Form a non-exclusive, royalty-free, perpetual license to use, modify,
                    and incorporate that content into our services.
                </p>

                <h2>7. Advertisements</h2>
                <p>
                    Thread Form displays advertisements from third-party ad networks, including Google
                ...
                <p>
                    Thread Form is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any
                ...
                <p>
                    To the fullest extent permitted by law, Thread Form and its operators shall not be
                ...
                <p>
                    We reserve the right to suspend or terminate your access to Thread Form at our sole
                ...
                <p>
                    ...
                    <strong>legal@threadform.org</strong>.
                </p>
            </div>
        </>
    );
