...
const SUPPORT_EMAIL = 'hello@threadform.org';

export const metadata: Metadata = {
    title: 'Contact Thread Form',
    description: 'Get in touch with the Thread Form team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Thread Form', 'Thread Form support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
