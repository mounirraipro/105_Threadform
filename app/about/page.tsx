...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Thread Form',
        url: 'https://threadform.org/about',
        description: 'Learn about Thread Form, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Thread Form',
...
export const metadata: Metadata = {
    title: 'About Us – Thread Form',
    description: 'Learn about Thread Form, our mission, and the team behind the game.',
    keywords: ['about Thread Form', 'game team', 'who made Thread Form'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Thread Form</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Thread Form was born from a simple idea: what if playing Thread Form could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Thread Form with a clear vision — to create a free, accessible, and
                    ...
                    Thread Form has something for you.
                </p>
                ...
                <p>
                    Every level in Thread Form is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Thread Form offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Thread Form better for
                    everyone.
                </p>
            </div>
        </>
