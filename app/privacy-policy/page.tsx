...
export const metadata: Metadata = {
    ...
    description: 'Read the Thread Form Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Thread Form privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Thread Form, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Thread Form, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Thread Form is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@threadform.org</strong>.
                </p>
            </div>
        </>
    );
