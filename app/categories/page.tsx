...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Thread Form puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Thread Form categories'],
  alternates: {
