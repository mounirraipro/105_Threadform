...
const SITE_URL = 'https://threadform.org';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Thread Form',
        url: SITE_URL,
        description: 'Play Thread Form free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Thread Form online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
