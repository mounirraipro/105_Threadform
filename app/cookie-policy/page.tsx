...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Thread Form uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Thread Form cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Thread Form uses them, and how you can
                ...
                <p>Thread Form uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Thread Form.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@threadform.org</strong>.
                </p>
            </div>
        </>
    );
