...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Thread Form disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Thread Form disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Thread Form (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on threadform.org
                ...
                <p>
                    Thread Form is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Thread Form displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Thread Form.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Thread Form is not responsible for any errors
